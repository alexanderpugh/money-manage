...
var decimal = require('../../../server/utilities/decimal');

var _require = require('../../../server/config/constants'),
    ANNUAL_MONTHS = _require.ANNUAL_MONTHS,
    ANNUAL_WEEKS = _require.ANNUAL_WEEKS,
    ANNUAL_WORKING_DAYS = _require.ANNUAL_WORKING_DAYS;

var formElement = document.querySelector('form');
var dataTotalYearlyAttrValue = parseFloat(formElement.getAttribute('data-totalYearly'));
var defaultTotalYearly = _.isNaN(dataTotalYearlyAttrValue) ? 0 : dataTotalYearlyAttrValue;
...
},{"../../../server/config/constants":5,"../../../server/utilities/decimal":6,"lodash":3,"vue/dist/vue.common":4}],3:[function(require,module,exports){
(function (global){
/**
 * @license
